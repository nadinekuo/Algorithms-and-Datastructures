...
// Arraylist heap implementation!!! (not linked)
...
class AdaptablePQ {
    ...
    private static class PQEntry implements Comparable<PQEntry> {
        ...
        private WeightedVertex value;

        private int index;                          // ADAPTABLE PQ: Entry stores index to efficiently replace key!

        public PQEntry(int key, WeightedVertex value, int index) {
            this.key = key;
            this.value = value;
            this.index = index;
        }
        ...
        protected WeightedVertex getValue() {
            return value;
        }
    ...
    private Map<WeightedVertex, PQEntry> entries = new HashMap<>();
     ...
     */
    private void insert(WeightedVertex vertex, int key) {
     ...
     */
    public void insertOrReplace(WeightedVertex vertex, int key) {
